...
Abaixo, apresentamos uma lista de stream_api envolvendo operações com streams para exercitar suas habilidades e criatividade.

Para todos os stream_api, utilizem a lista de números inteiros fornecida:
...
- Os stream_api podem ser executados individualmente a partir dos métodos main de cada classe.
- Utilize a Stream API para implementar as operações solicitadas em cada desafio.

Divirta-se resolvendo os stream_api da Stream API do Java!<br>
